...
templates['card.hbs'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"card\">\r\n    <div class=\"card_image_wrapper\"><img class=\"card_image\" src=\"../../static/images/no.png\"></div>\r\n    <div class=\"card_details\"><div class=\"title\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"title") || (depth0 != null ? lookupProperty(depth0,"title") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data,"loc":{"start":{"line":3,"column":49},"end":{"line":3,"column":58}}}) : helper)))
    + "</div><img class=\"like\" src=\"../../static/images/like.svg\"></div>\r\n    <span class=\"price\">"
