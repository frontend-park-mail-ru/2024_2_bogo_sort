...
templates['auth.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<form action=\"\">\r\n    <div class=\"auth_wrapper\">   \r\n        <div class=\"features\">\r\n            <span class=\"features_logo\">Эмпориум</span>\r\n            <span class=\"feature\"><img src=\"../../static/images/money.svg\" class=\"icon\"> Быстро и удобно продать или купить товары</span>\r\n            <span class=\"feature\"><img src=\"../../static/images/time.svg\" class=\"icon\"> Найти работу или предложить услугу</span>\r\n            <span class=\"feature\"><img src=\"../../static/images/tools.svg\" class=\"icon\"> Найти профессионала под специализированную задачу</span>\r\n        </div>\r\n\r\n        <div class=\"auth\">\r\n            <h1 class=\"authorization\">"
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"inputs") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":16,"column":16},"end":{"line":18,"column":25}}})) != null ? stack1 : "")
    + "                <button type=\"button\" class=\"authorization_enter\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"buttontitle") || (depth0 != null ? lookupProperty(depth0,"buttontitle") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"buttontitle","hash":{},"data":data,"loc":{"start":{"line":19,"column":66},"end":{"line":19,"column":81}}}) : helper)))
    + "</button>\r\n                <span class=\"registration_link\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"pretext") || (depth0 != null ? lookupProperty(depth0,"pretext") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"pretext","hash":{},"data":data,"loc":{"start":{"line":20,"column":48},"end":{"line":20,"column":59}}}) : helper)))
    + " <a class=\"registration_link link\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"anchortext") || (depth0 != null ? lookupProperty(depth0,"anchortext") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"anchortext","hash":{},"data":data,"loc":{"start":{"line":20,"column":94},"end":{"line":20,"column":108}}}) : helper)))
    + "</a></span>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</form>\r\n";
},"useData":true});
})();